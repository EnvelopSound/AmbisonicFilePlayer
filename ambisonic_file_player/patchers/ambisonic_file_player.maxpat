...
,
		"openrect" : [ 659.0, 329.0, 198.0, 408.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.896271, 202.021057, 102.0, 29.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 55.866241, 472.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 27.366241, 436.0, 57.0, 22.0 ],
					"style" : "",
					"text" : "strippath"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 27.366241, 336.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "t s s"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 29.866241, 596.5, 158.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.125, 346.0, 181.875, 20.0 ],
					"style" : "",
					"text" : "env.decode.quad.maxpat",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.866241, 550.0, 47.0, 22.0 ],
					"style" : "",
					"text" : "text $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.866241, 631.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "open 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.866241, 376.0, 97.0, 22.0 ],
					"style" : "",
					"text" : "patchername $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 116.866241, 196.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.866241, 229.0, 54.0, 22.0 ],
					"style" : "",
					"text" : "open $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 16,
					"numoutlets" : 0,
					"patching_rect" : [ 280.566498, 487.0, 144.31929, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"formantcorrection" : 0,
						"mode" : "basic",
						"originallength" : [ 36199.621094, "ticks" ],
						"originaltempo" : 120.0,
						"pitchcorrection" : 0,
						"quality" : "basic",
						"timestretch" : [ 0 ]
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"formantcorrection" : 0,
						"mode" : "basic",
						"originallength" : [ 115578.882812, "ticks" ],
						"originaltempo" : 120.0,
						"pitchcorrection" : 0,
						"quality" : "basic",
						"timestretch" : [ 0 ]
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 237.75705, 299.0, 164.0, 22.0 ],
...
,
					"snapshot" : 					{
						...
						"snapshot" : 						{
							...
							"blob" : "271.CMlaKA....fQPMDZ....ADzPuEC...fB..............................................vzVMjLgnL....OMkETLU0QI4zTEQEUI4zQSAhXug2WvIWYyUFcy0iHh.RZt80bkE2WvElbg0VOh.iHf7Vcz80bkE2WvElbg0VOh.iHfjlae41ax01WvElbg0VOh.iHf7Vcz8kauIWaeAWXxEVa8HBLh.hYrkFbeM1beAGZgMWY8HBLh.hYrkFbeAWXxEVa8HBLh.hYr8FbeAWXxEVa8HBLh.hYrEFbeAWXxEVa8HBLh.RZt8kLj8EbgIWXs0iHvHBHuUGceICYeAWXxEVa8HBLh7hO.."
						}
,
						"snapshotlist" : 						{
							"current_snapshot" : 0,
...
,
									"fileref" : 									{
										"name" : "ambix_converter_o1",
										"filename" : "ambix_converter_o1.maxsnap",
										"filepath" : "~/Code/AmbisonicFilePlayer/ambisonic_file_player/data",
										"filepos" : -1,
										"snapshotfileid" : "5067a8e72481d64ba3be10af83ba74ef"
									}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 27.366241, 279.0, 33.0, 42.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 295.590393, 402.0, 339.0, 402.0, 339.0, 414.0, 337.484894, 414.0 ],
					"source" : [ "obj-5", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 279.479279, 402.0, 321.678772, 402.0 ],
					"source" : [ "obj-5", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 263.368164, 411.0, 305.87262, 411.0 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 207.990814, 245.5, 295.590393, 245.5 ],
					"source" : [ "obj-82", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 360.71933, 245.5, 295.590393, 245.5 ],
					"source" : [ "obj-83", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 534.821716, 245.5, 295.590393, 245.5 ],
					"source" : [ "obj-97", 1 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "ambix_converter_o1.maxsnap",
				"bootpath" : "~/Code/AmbisonicFilePlayer/ambisonic_file_player/data",
				"type" : "mx@s",
				"implicit" : 1
			}
, 			{
